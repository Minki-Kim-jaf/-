...
/** end of 1-1 르탄이 그리기 */
/** 2-1 장애물 설정 */
const OBSTACLE_WIDTH = 75; // 장애물 너비
const OBSTACLE_HEIGHT = 75; // 장애물 높이
const OBSTACLE_FREQUENCY = 95; // 장애물 생성 빈도
